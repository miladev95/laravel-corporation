                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="inbox.html" class="waves-effect active"><i class="zmdi zmdi-settings"></i><span>تنظیمات عمومی</span></a>
                            </li>
                                          			...
                                          			<div class="row">
                                          				<div class="col-lg-6">
                                          					<form class="form-horizontal" role="form">
                  	                                            ...
                  	                                            <div class="form-group">
                  	                                                <label class="col-md-2 control-label">نوع متن</label>
                  	                                                <div class="col-md-10">
                                          				...
                                          				<div class="col-lg-6">
                                          					<form class="form-horizontal" role="form">
                  	                                            <div class="form-group">
                  	                                                <label class="col-md-2 control-label">فقط خواندنی</label>
                  	                                                <div class="col-md-10">
                  	                                                    <input type="text" class="form-control" readonly value="فقط خواندنی">
                  	                                                </div>
                  	                                            </div>
                  	                                            <div class="form-group">
                  	                                                <label class="col-md-2 control-label">غیر فعال</label>
                  	                                                <div class="col-md-10">
                  	                                                    <input type="text" class="form-control" disabled="" value="غیر فعال">
                  	                                                </div>
                  	                                            </div>
                  	                                            <div class="form-group">
