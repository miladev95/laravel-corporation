...
<head>
  ...
  <meta name="author" content="apps4.ir">

  <meta name="description" content="CreaTec - Responsive Multipurpose HTML5 Bootstrap Website Template">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4">
        ...
        <a class="qt-header-logo" href="index.html">
          <img src={{ URL::asset("resources/img/logo.png") }} class="img-responsive" alt="Logo">
        </a>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="qt-featured-image qt-page-featured-image">
          <img src="resources/img/featured-5.jpg" alt="Welcome to CreaTec Website London">
        </div>
            ...
            <ul class="list-group row qt-sidebar-news-listing">
              ...
              <li class="list-group-item col-sm-4 col-md-12 qt-sidebar-news-item">
                <a class="fade qt-sidebar-news-item-img" href="blog-single-post.html">
                  <img src="resources/img/thumbnail-1-sm.jpg" alt="A good news item title for the sidebar">
                </a>
              ...
              <li class="list-group-item col-sm-4 col-md-12 qt-sidebar-news-item">
                <a class="fade qt-sidebar-news-item-img" href="blog-single-post.html">
                  <img src="resources/img/thumbnail-2-sm.jpg" alt="A good news item title for the sidebar">
                </a>
              ...
              <li class="list-group-item col-sm-4 col-md-12 qt-sidebar-news-item">
                <a class="fade qt-sidebar-news-item-img" href="blog-single-post.html">
                  <img src="resources/img/thumbnail-3-sm.jpg" alt="A good news item title for the sidebar">
                </a>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-3">
        <a href="photo-gallery-6-col.html" class="qt-fade qt-photo-item">
          <h4>تصویر 3</h4>
          <img class="" src="resources/img/gallery/11.jpg" alt="">
        </a>
      </div>
